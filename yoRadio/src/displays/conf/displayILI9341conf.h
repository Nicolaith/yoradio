...
#define bootLogoTop     68
  ...
  #define VoltX      180				// X coordinate for voltage (Координата X для напряжения)
  #define VoltY      208				// Y coordinate for voltage (Координата X для напряжения)
...
//const VUBandsConfig bandsConf     PROGMEM = { 150, 20, 8, 1, 10, 5 };
